...
\thispagestyle{empty}
\movetooddpage
\addcontentsline{toc}{chapter}{\versal{FRAGMENTOS DE UM DIÁRIO ENCONTRADO}}
...
\begin{center}
\vspace*{-1.8cm}
\hspace*{-1.4cm}\includegraphics[width=110mm]{./imgs/rua.jpg}
\end{center}
%\end{vplace}
...
\begin{center}
%\vspace*{-2cm}
\hspace*{-1.4cm}\includegraphics[width=110mm]{./imgs/praia.jpg}
\end{center}
%\end{vplace}
...
\begin{center}
%\vspace*{-2cm}
\hspace*{-1.2cm}\includegraphics[width=110mm]{./imgs/canal1.jpg}
\end{center}
%\end{vplace}
