...
Enquanto narrava o acontecido a \versal{M.\,D.}, ele lançou a seguinte
...
O que devo fazer com todas essas folhas mortas, que \versal{M.\,D.} chama de
...
\versal{M.\,D.}, que é médico, sofre de uma deformação profissional.~Toma medidas
...
indiferente, \versal{E.} voltou da soleira da porta. Estava surpresa. Talvez
...
campeão ser derrotado numa luta de boxe. Mas como poderia \versal{E.} chegar a
...
\begin{center}
\vspace*{-1.97cm}
\hspace*{-1.39cm}\includegraphics[width=110mm]{./imgs/rua.png}
\end{center}
%\end{vplace}
...
\versal{M.\,D.}, médico e psicólogo, afirma que desprezo minha própria
inteligência.
...
Logrei realizar a façanha --- e me admiro com o fato de que \versal{M.\,D.}, amante
...
Que volúpia seleta! Oh, esse \versal{M.\,D.} que defende os direitos da
inteligência contra mim! Quando terá tido ele semelhante alegria?

\chapter*{}
\section{viii}

De uma carta enviada por \versal{E.} (que está em Bordeaux já faz duas semanas):
...
De maneira que ela também, a doce, suave e loira \versal{E.}, também acabou
...
pode recusar nem abdicando. A minha solidão é uma delas. \enlargethispage{\baselineskip}
...
Ploumanach\ldots{}) Todos os outros não passaram de acréscimos ou
subtrações de uma alma padrão. \versal{X} é mais inteligente que \versal{Y}, mas \versal{Y} é mais
sutil que \versal{Z}, que, por sua vez, é mais espiritual que \versal{X.}
...
Mantenho, dentre minhas antigas paixões, uma grande aversão:
Descartes.
...
Entre Havre e Rouen, \versal{D.\,L.} desceu do automóvel, carregou o revólver e
...
porque \versal{D.\,L.} estava com fome.
...
\begin{center}
\vspace*{-1.97cm}
\hspace*{-1.39cm}\includegraphics[width=110mm]{./imgs/praia.png}
\end{center}
%\end{vplace}
...
Apenas \versal{O.}, a morena baixinha e decidida de Talloires, em 1926, encarou a
...
\versal{O.} se tornara uma verdadeira amante. Que decadência!
...
\begin{center}
\vspace*{-1.92cm}
\hspace*{-1.39cm}\includegraphics[width=110mm]{./imgs/canal.png}
\end{center}
\end{vplace}
...
Noite na Île Saint"-Louis, na casa de \versal{T.}, que voltou da Argentina depois
...
Conversamos sobre livros, mulheres e países. \versal{T.}, que em meio à sua
...
Reflexão feita por \versal{T.} ontem no restaurante para onde me levara após
...
Acho que o que nos faz viver, a \versal{T.}, a mim e a todas as pessoas é
...
\versal{T.} pediu que falasse de mim.
...
íntimo comigo mesmo ou com os outros \mbox{---,} pegava o meu chapéu e ia embora.
...
``Você é mau?'', pergunta \versal{E.}, baseando"-se em suas pobres nostalgias
