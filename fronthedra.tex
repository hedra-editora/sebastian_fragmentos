...
\ifdef{\tradutor}{{\footnotesize {\tradutor} (\textit{tradução})}\par}{}\vspace{4em}
...
\begin{multicols}{2}
\raggedleft\tiny\noindent{}\emph{Traducerea a fost realizată în cadrul Programului Rezidențele \textsc{filit} pentru traducători 2019, la Brăila.}


\raggedright\tiny\noindent{}\emph{A tradução foi realizada no contexto do Programa de Residências \textsc{filit} para Tradutores 2019, em Brăila.}
\end{multicols}
\begin{center}
