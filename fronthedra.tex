...
{\Formular\Large\textbf \autor \par\vspace{1.5ex}}
...
\ifdef{\tradutor}{{\footnotesize {\tradutor} (\textit{tradução})}\par}{}\vspace{1.5cm}

{{\scriptsize{} \ifdef{\numeroedicao}{\numeroedicao}{1}ª edição} \par}

%logos
\vfill
\ifdef{\logo}{\IfFileExists{\logo}{\hfill\includegraphics[width=3cm]{./logo.png}\hfill\logoum{}\\ São Paulo\quad2020}}{\includegraphics[width=2.5cm]{./imgs/logo.png}\break{} São Paulo\quad2020}
...
\begin{multicols}{2}
\raggedleft\tiny\noindent{}\emph{Traducerea a fost realizată în cadrul Programului Rezidențele \versal{FILIT} pentru traducători 2019, la Brăila.}


\raggedright\tiny\noindent{}\emph{A tradução foi realizada no contexto do Programa de Residências \versal{FILIT} para Tradutores 2019, em Brăila.}
\end{multicols}
\begin{center}
